...
func _on_TextEdit_text_changed():
	event_data['statement'] = $PanelContainer/VBoxContainer/TextEdit.text
	update_preview()


func load_text(text):
	get_node("VBoxContainer/TextEdit").text = text
	event_data['statement'] = text
	update_preview()


func load_data(data):
	event_data = data
	$PanelContainer/VBoxContainer/TextEdit.text = event_data['statement']
	update_preview()
